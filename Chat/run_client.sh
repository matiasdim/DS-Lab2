...
#java -cp src:public_html/classes/server.jar -Djava.rmi.server.codebase=http://35.40.124.177/classes -Djava.security.policy=src/client/client.policy -Djava.rmi.server.useCodebaseOnly=false client.Client $1 $2 $3