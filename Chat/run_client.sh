...
cd ..
java -cp src:public_html/classes/server.jar -Djava.rmi.server.codebase=http://localhost/classes -Djava.security.policy=src/client/client.policy -Djava.rmi.server.useCodebaseOnly=false client.Client localhost $1 $2 $3
